...
public class LoggingListeners extends ListenerAdapter {
    ...
    public void onMessageUpdate(MessageUpdateEvent event) {
        ...
        MessageEmbed embed = new EmbedBuilder()
                ...
                .setColor(Color.BLUE)
                .addField("User", event.getAuthor().getAsMention() + "(" + event.getAuthor().getAsTag() + ")", false)
    ...
    */
    ...
    public void onGuildInviteCreate(GuildInviteCreateEvent event) {
        ...
        MessageEmbed embed = new EmbedBuilder()
                ...
                .setColor(Color.GREEN)
                .addField("User", event.getInvite().getInviter() == null ? "Could not get user" : event.getInvite().getInviter().getAsMention() + " (" + event.getInvite().getInviter().getAsTag() + ")", false)
